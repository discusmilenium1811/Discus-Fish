      ...
      <header className="border-b border-white/10 bg-slate-950/60 backdrop-blur-lg">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 sm:gap-4 sm:px-6 sm:py-5">
          <div className="flex items-start gap-4 sm:gap-8">
            ...
            <div className="flex min-w-0 flex-1 flex-col justify-center gap-2 self-stretch sm:flex-row sm:items-center sm:gap-8">
              {accountName && (
              ...
              <p className="min-w-0 flex-1 bg-gradient-to-r from-orange-300 via-cyan-200 via-45% to-teal-300 bg-clip-text text-2xl font-black leading-tight text-transparent drop-shadow-[0_0_18px_rgba(34,211,238,0.22)] sm:text-5xl lg:text-6xl">
                {t('nav.tagline')}
              </p>
            </div>
          ...
          <div className="relative flex flex-wrap items-center justify-center gap-2 sm:items-start sm:gap-3.5 sm:pr-40">
          <Link
            to="/shipping-prices"
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            className="group relative order-first flex h-12 w-full items-center justify-center gap-3 overflow-hidden rounded-full border border-cyan-300/30 bg-gradient-to-r from-cyan-400/15 via-white/5 to-emerald-400/15 px-4 text-[0.65rem] font-extrabold uppercase tracking-[0.1em] text-white shadow-[0_8px_25px_rgba(6,182,212,0.1)] transition hover:border-cyan-300/60 hover:bg-white/10 sm:absolute sm:left-1/2 sm:h-14 sm:w-fit sm:-translate-x-1/2 sm:flex-none sm:justify-start sm:px-5 sm:text-xs"
          ...
          {!user && (
            <button
              ...
              className="inline-flex h-9 items-center gap-2 rounded-full border border-cyan-300/25 bg-cyan-300/10 px-3 text-xs font-bold text-cyan-100 transition hover:border-cyan-300/50 hover:bg-cyan-300/15 sm:ml-auto sm:h-12 sm:px-5 sm:text-base"
            >
          ...
          <div className="flex w-28 shrink-0 flex-col items-center sm:absolute sm:-top-40 sm:right-0 sm:w-36">
            <img
              src={PARTNER_LOGO}
              alt={PARTNER_LOGO_ALT}
              className="h-28 w-28 rounded-2xl object-contain shadow-sm sm:h-36 sm:w-36"
            />
            <p className="mt-2 text-center text-xs leading-5 text-slate-400">{t('footer.partner')}</p>
          </div>
