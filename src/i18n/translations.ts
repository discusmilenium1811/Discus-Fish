...
export const translations = {
  en: {
    ...
    'shipping.byWeight': 'Price by parcel weight',
    'shipping.weightCol': 'Parcel weight',
    'shipping.priceCol': 'UPS price',
    'shipping.weightNote': 'The exact price is calculated from your order’s total weight at checkout.',
    ...
    'cart.pickupOffice': 'AKIS Express office',
    'cart.pickupOfficeSelect': 'Select an office…',
    'cart.pickupOfficeHint':
      'Collect your order from the chosen office with your name and phone number. Most offices: Mon–Fri 07:30–18:30, Sat 08:30–13:30.',
    'cart.pickupOfficeRequired': 'Please choose the AKIS Express office to collect your order from.',
    ...
    'auth.updatePasswordTitle': 'Set a new password',
    'auth.updatePasswordDesc': 'Choose a new password for your account.',
    'auth.setNewPassword': 'Update password',
    ...
    'auth.passwordHintBusiness': 'At least {n} characters — business accounts need a stronger password',
    'auth.errPasswordLeaked': 'This password appeared in a known data breach. Please choose a different one.',
    'auth.errPasswordWeak': 'This password is too weak. Please choose a stronger one.',
    'auth.errGeneric': 'Something went wrong. Please try again.',
    'auth.or': 'or',
    'auth.continueGoogle': 'Continue with Google',
    'auth.pwStrengthLabel': 'Strength',
    'auth.pwStrength0': 'Very weak',
    'auth.pwStrength1': 'Weak',
    'auth.pwStrength2': 'Fair',
    'auth.pwStrength3': 'Good',
    'auth.pwStrength4': 'Strong',
    'auth.pwMinLength': 'At least {n} characters needed',
    // Two-factor authentication (business & admin)
    'mfa.setupTitle': 'Set up two-factor authentication',
    'mfa.setupDesc':
      'Your account requires 2FA. Scan the QR code with an authenticator app (Google Authenticator, Authy, 1Password…), then enter the 6-digit code to activate it.',
    'mfa.challengeTitle': 'Two-factor authentication',
    'mfa.challengeDesc': 'Enter the 6-digit code from your authenticator app to continue.',
    'mfa.qrAlt': 'Two-factor QR code',
    'mfa.secretLabel': 'Or enter this key manually',
    'mfa.loading': 'Preparing…',
    'mfa.verifying': 'Verifying…',
    'mfa.activate': 'Activate 2FA',
    'mfa.verify': 'Verify',
    'mfa.errCode': 'Invalid or expired code. Please try again.',
  ...
  el: {
    ...
    'shipping.byWeight': 'Τιμή ανά βάρος δέματος',
    'shipping.weightCol': 'Βάρος δέματος',
    'shipping.priceCol': 'Τιμή UPS',
    'shipping.weightNote': 'Η ακριβής τιμή υπολογίζεται από το συνολικό βάρος της παραγγελίας σας κατά την ολοκλήρωση.',
    ...
    'cart.pickupOffice': 'Γραφείο AKIS Express',
    'cart.pickupOfficeSelect': 'Επιλέξτε γραφείο…',
    'cart.pickupOfficeHint':
      'Παραλάβετε την παραγγελία από το επιλεγμένο γραφείο με το όνομα και το τηλέφωνό σας. Τα περισσότερα γραφεία: Δευ–Παρ 07:30–18:30, Σάβ 08:30–13:30.',
    'cart.pickupOfficeRequired': 'Επιλέξτε το γραφείο AKIS Express από το οποίο θα παραλάβετε την παραγγελία.',
    ...
    'auth.updatePasswordTitle': 'Ορίστε νέο κωδικό',
    'auth.updatePasswordDesc': 'Επιλέξτε νέο κωδικό για τον λογαριασμό σας.',
    'auth.setNewPassword': 'Ενημέρωση κωδικού',
    'auth.username': 'Όνομα χρήστη',
    'auth.email': 'Email',
    'auth.password': 'Κωδικός',
    'auth.oldPassword': 'Παλιός κωδικός',
    'auth.newPassword': 'Νέος κωδικός',
    'auth.passwordHint': 'Τουλάχιστον {n} χαρακτήρες',
    ...
    'auth.errPasswordShort': 'Ο κωδικός πρέπει να έχει τουλάχιστον {n} χαρακτήρες.',
    ...
    'auth.passwordHintBusiness': 'Τουλάχιστον {n} χαρακτήρες — οι επαγγελματικοί λογαριασμοί χρειάζονται ισχυρότερο κωδικό',
    'auth.errPasswordLeaked': 'Αυτός ο κωδικός έχει εμφανιστεί σε γνωστή διαρροή δεδομένων. Επιλέξτε διαφορετικό.',
    'auth.errPasswordWeak': 'Αυτός ο κωδικός είναι πολύ αδύναμος. Επιλέξτε ισχυρότερο.',
    'auth.errGeneric': 'Κάτι πήγε στραβά. Δοκιμάστε ξανά.',
    'auth.or': 'ή',
    'auth.continueGoogle': 'Συνέχεια με Google',
    'auth.pwStrengthLabel': 'Ισχύς',
    'auth.pwStrength0': 'Πολύ αδύναμος',
    'auth.pwStrength1': 'Αδύναμος',
    'auth.pwStrength2': 'Μέτριος',
    'auth.pwStrength3': 'Καλός',
    'auth.pwStrength4': 'Ισχυρός',
    'auth.pwMinLength': 'Απαιτούνται τουλάχιστον {n} χαρακτήρες',
    // Two-factor authentication (business & admin)
    'mfa.setupTitle': 'Ρύθμιση ελέγχου ταυτότητας δύο παραγόντων',
    'mfa.setupDesc':
      'Ο λογαριασμός σας απαιτεί 2FA. Σαρώστε τον κωδικό QR με μια εφαρμογή authenticator (Google Authenticator, Authy, 1Password…) και εισαγάγετε τον 6ψήφιο κωδικό για ενεργοποίηση.',
    'mfa.challengeTitle': 'Έλεγχος ταυτότητας δύο παραγόντων',
    'mfa.challengeDesc': 'Εισαγάγετε τον 6ψήφιο κωδικό από την εφαρμογή authenticator για να συνεχίσετε.',
    'mfa.qrAlt': 'Κωδικός QR δύο παραγόντων',
    'mfa.secretLabel': 'Ή εισαγάγετε αυτό το κλειδί χειροκίνητα',
    'mfa.loading': 'Προετοιμασία…',
    'mfa.verifying': 'Επαλήθευση…',
    'mfa.activate': 'Ενεργοποίηση 2FA',
    'mfa.verify': 'Επαλήθευση',
    'mfa.errCode': 'Μη έγκυρος ή ληγμένος κωδικός. Δοκιμάστε ξανά.',
    // Account type tabs + business account
  ...
  bg: {
    ...
    'shipping.byWeight': 'Цена според теглото на пратката',
    'shipping.weightCol': 'Тегло на пратката',
    'shipping.priceCol': 'Цена UPS',
    'shipping.weightNote': 'Точната цена се изчислява от общото тегло на поръчката при плащане.',
    ...
    'cart.pickupOffice': 'Офис на AKIS Express',
    'cart.pickupOfficeSelect': 'Изберете офис…',
    'cart.pickupOfficeHint':
      'Получавате поръчката от избрания офис с името и телефонния си номер. Повечето офиси: пон–пет 07:30–18:30, съб 08:30–13:30.',
    'cart.pickupOfficeRequired': 'Моля, изберете офиса на AKIS Express, от който ще получите поръчката.',
    ...
    'auth.updatePasswordTitle': 'Задайте нова парола',
    'auth.updatePasswordDesc': 'Изберете нова парола за вашия акаунт.',
    'auth.setNewPassword': 'Обнови паролата',
    'auth.username': 'Потребителско име',
    'auth.email': 'Имейл',
    'auth.password': 'Парола',
    'auth.oldPassword': 'Стара парола',
    'auth.newPassword': 'Нова парола',
    'auth.passwordHint': 'Поне {n} символа',
    ...
    'auth.errPasswordShort': 'Паролата трябва да е поне {n} символа.',
    ...
    'auth.passwordHintBusiness': 'Поне {n} символа — бизнес акаунтите изискват по-силна парола',
    'auth.errPasswordLeaked': 'Тази парола е открита в известно изтичане на данни. Моля, изберете друга.',
    'auth.errPasswordWeak': 'Тази парола е твърде слаба. Моля, изберете по-силна.',
    'auth.errGeneric': 'Нещо се обърка. Моля, опитайте отново.',
    'auth.or': 'или',
    'auth.continueGoogle': 'Продължи с Google',
    'auth.pwStrengthLabel': 'Сила',
    'auth.pwStrength0': 'Много слаба',
    'auth.pwStrength1': 'Слаба',
    'auth.pwStrength2': 'Средна',
    'auth.pwStrength3': 'Добра',
    'auth.pwStrength4': 'Силна',
    'auth.pwMinLength': 'Необходими са поне {n} символа',
    // Two-factor authentication (business & admin)
    'mfa.setupTitle': 'Настройка на двуфакторна автентикация',
    'mfa.setupDesc':
      'Вашият акаунт изисква 2FA. Сканирайте QR кода с приложение за автентикация (Google Authenticator, Authy, 1Password…) и въведете 6-цифрения код, за да го активирате.',
    'mfa.challengeTitle': 'Двуфакторна автентикация',
    'mfa.challengeDesc': 'Въведете 6-цифрения код от вашето приложение за автентикация, за да продължите.',
    'mfa.qrAlt': 'QR код за двуфакторна автентикация',
    'mfa.secretLabel': 'Или въведете този ключ ръчно',
    'mfa.loading': 'Подготовка…',
    'mfa.verifying': 'Проверка…',
    'mfa.activate': 'Активирай 2FA',
    'mfa.verify': 'Потвърди',
    'mfa.errCode': 'Невалиден или изтекъл код. Моля, опитайте отново.',
    // Account type tabs + business account
